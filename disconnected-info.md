...
> For Disconnected Mirroring automation see https://github.com/kenmoini/ocp4-disconnected-helper

## Post Cluster Deployment Configuration

### 1. Create a ConfigMap in `openshift-config` with the additionalTrustBundle
...
### 2. Set the Proxy config to the name of that ConfigMap
...
### 3. Configure the Image Cluster Config with:
